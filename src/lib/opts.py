...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--epochs', default=110, type=int)
    ...
    self.parser.add_argument('--with_box_refine', default=False, action='store_true')
    self.parser.add_argument('--two_stage', default=False, action='store_true')

    # Model parameters
    self.parser.add_argument('--frozen_weights', type=str, default=None,
    ...
    self.parser.add_argument('--num_queries', default=300, type=int,
    ...
    # dataset parameters
    self.parser.add_argument('--dataset_file', default='coco')
    self.parser.add_argument('--coco_path', default='./data/coco', type=str)
    self.parser.add_argument('--coco_panoptic_path', type=str)
    self.parser.add_argument('--remove_difficult', action='store_true')

    self.parser.add_argument('--output_dir', default='',
    ...
    self.parser.add_argument('--start_epoch', default=0, type=int, metavar='N',
                             help='start epoch')
    self.parser.add_argument('--eval', default=False, action='store_true')
    self.parser.add_argument('--num_workers', default=8, type=int)
    self.parser.add_argument('--cache_mode', default=False, action='store_true',
    ...
    self.parser.add_argument('--data_dir', type=str, default='/mnt/storage/Dataset/')
