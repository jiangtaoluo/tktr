...
def eval_seq(opt, dataloader, data_type, result_filename, save_dir=None, show_image=True, frame_rate=30, use_cuda=True):
    ...
    for i, (path, img, img0) in enumerate(dataloader):
        ...
        normalize = transforms.Compose([
            transforms.ToTensor(),
            transforms.Normalize([0.408, 0.447, 0.470], [0.289, 0.274, 0.278])
        ])
        img_norm = transforms.Compose([T.RandomResize([800], max_size=1333), normalize])
...
if __name__ == '__main__':
    ...
    #                   MOT17-12-SDP
    #                   MOT17-14-SDP'''
    #     data_root = os.path.join(opt.data_dir, 'JDE/MOT17/images/test')
    if opt.test_mot17:
    ...
    if opt.val_mot17:
        seqs_str = '''MOT17-02-SDP
                      ...
                      MOT17-11-SDP
                      MOT17-13-SDP'''
        data_root = os.path.join(opt.data_dir, 'JDE/MOT17/images/train')
    # if opt.val_mot17:
